...
uint8_t *et4000w32isa_8x16;

uint8_t *BLADE3D_AGP_HIS__8x16;

void gen_fonts(){
	et4000w32isa_8x16 = (uint8_t*)kmalloc(4096 * sizeof(uint8_t));
	serial_printf("premier malloc réussi\n");
    BLADE3D_AGP_HIS__8x16 = (uint8_t*)kmalloc(4096 * sizeof(uint8_t));
	serial_printf("deuxième malloc réussi\n");
    g_8x16_font = (uint8_t*)kmalloc(4096 * sizeof(uint8_t));
	serial_printf("troisième malloc réussi\n");
	// Vérifier si l'allocation s'est effectuée correctement
    if (et4000w32isa_8x16 == NULL || BLADE3D_AGP_HIS__8x16 == NULL || g_8x16_font == NULL) {
        serial_printf("Erreur lors de l'allocation de mémoire pour les tableaux.\n");
        return;
    }
	memcpy(et4000w32isa_8x16, (uint8_t[]){
	...
	serial_printf("premier memcpy réussi\n");
	memcpy(g_8x16_font, (uint8_t[]){
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
		0x00, 0x00, 0x7e, 0x81, 0xa5, 0x81, 0x81, 0xbd, 0x99, 0x81, 0x81, 0x7e, 0x00, 0x00, 0x00, 0x00, 
		0x00, 0x00, 0x7e, 0xff, 0xdb, 0xff, 0xff, 0xc3, 0xe7, 0xff, 0xff, 0x7e, 0x00, 0x00, 0x00, 0x00, 
		0x00, 0x00, 0x00, 0x00, 0x6c, 0xfe, 0xfe, 0xfe, 0xfe, 0x7c, 0x38, 0x10, 0x00, 0x00, 0x00, 0x00, 
	...
	serial_printf("deuxième memcpy réussi\n");
	memcpy(BLADE3D_AGP_HIS__8x16, (uint8_t[]){
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
		0x00, 0x00, 0x7e, 0x81, 0xa5, 0x81, 0x81, 0xbd, 0x99, 0x81, 0x81, 0x7e, 0x00, 0x00, 0x00, 0x00, 
		0x00, 0x00, 0x7e, 0xff, 0xdb, 0xff, 0xff, 0xc3, 0xe7, 0xff, 0xff, 0x7e, 0x00, 0x00, 0x00, 0x00, 
		0x00, 0x00, 0x00, 0x00, 0x6c, 0xfe, 0xfe, 0xfe, 0xfe, 0x7c, 0x38, 0x10, 0x00, 0x00, 0x00, 0x00, 
	...
	serial_printf("troisième memcpy réussi\n");
}